...
Professionally, I'm a full-stack developer who likes his code clean, solutions robust, and pipelines automated: the proactive, reliable kind of guy who loathes debt—financial and technical.
...
Profissionalmente, sou um desenvolvedor full stack que gosta do código limpo, soluções robustas e fluxos automatizados: o tipo de pessoa proativa e fiável que detesta "dívidas", sejam elas financeiras ou tech debt.
